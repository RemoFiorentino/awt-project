...
exports.createInitializer = function (options) {
    var items = [
        require('./login-view').createInitializer(options)
        ,require('./login-form').createInitializer(options)
        ,require('./on-login-submit').createInitializer(options)
    ];
    ...
    ViewModel.prototype.main = 'login-view';
