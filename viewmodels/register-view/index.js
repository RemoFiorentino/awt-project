...
exports.createInitializer = function (options) {
    var items = [
        require('./register-view').createInitializer(options)
        ,require('./register-form').createInitializer(options)
        ,require('./on-register-submit').createInitializer(options)
    ];
    ...
    ViewModel.prototype.main = 'register-view';
