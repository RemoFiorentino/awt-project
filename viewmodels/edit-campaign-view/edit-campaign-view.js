...
exports.createInitializer = function (options) {
    ...
    ViewModel.prototype.compute = function () {
        ...
        return this.computing = Promise.all([
            this.context.elements['edit-campaign-form'].compute()
            ,this.context.elements['go-to-images-upload'].compute()
            ,this.context.elements['go-to-workers'].compute()
        ]).then(function () {
            self.computed = true;
        });
    };
    ...
    ViewModel.prototype.toQuery = function (event) {
        return merge(
            this.context.elements['edit-campaign-form'].toQuery(event)
        );
    };
